...
insert into was_address(title, name, street, streetNumber, zipCode, city) values ('Dr.', 'Master of Deaster', 'Street', '1', '12345', 'Berlin')
insert into was_user(email, password, passwordSalt, activationKey, signinAttempts, address_id) values ('master@desaster.net', 'fsbv1UooTJ3hPChjo5HgY9T5caG6TG4xY7Qb10k2T8E=', '7MkZdGswgzvk1cDocG4v', 'activationkey', 0, (select id from was_address where city like 'Berlin'))
insert into was_user_role(user_id, role_id) values ((select id from was_user where email = 'master@desaster.net'), (select id from was_role where name = 'ADMIN'))
